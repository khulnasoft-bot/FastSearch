...
//! [fields](https://github.com/khulnasoft-lab/fastsearch/blob/v0.19.0/include/field.)
//! available in Fastsearch.

mod field_type;
pub use field_type::*;
pub use fastsearch_codegen::models::{Field, FieldEmbed};

/// Builder for the `Field` struct.
#[derive(Debug, Default)]
pub struct FieldBuilder {
    name: String,
    fastsearch_type: FieldType,
...
impl FieldBuilder {
    /// Create a Builder
    #[inline]
    pub fn new(name: impl Into<String>, fastsearch_type: FieldType) -> Self {
        Self {
            name: name.into(),
            fastsearch_type,
            ..Default::default()
    ...
    /// It can fail if the name or the fastsearch_type are not defined.
    #[inline]
    pub fn build(self) -> Field {
        Field {
            name: self.name,
            r#type: self.fastsearch_type,
