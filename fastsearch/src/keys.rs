...
//!
//! More info [here](https://khulnasoft.com/docs/0.20.0/api/api-keys.html).
...
use sha2::Sha256;
use fastsearch_codegen::models::ScopedKeyParameters;

/// Generate a scoped search API key that can have embedded search parameters in them.
///
/// More info [here](https://khulnasoft.com/docs/0.20.0/api/api-keys.html#generate-scoped-search-key).
...
///
/// More info [here](https://khulnasoft.com/docs/0.25.2/api/api-keys.html#sample-actions).
