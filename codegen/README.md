...
*HealthApi* | [**health**](docs/HealthApi.md#health) | **GET** /health | Checks if Fastsearch server is ready to accept requests.
...
*OperationsApi* | [**take_snapshot**](docs/OperationsApi.md#take_snapshot) | **POST** /operations/snapshot | Creates a point-in-time snapshot of a Fastsearch node's state and data in the specified directory.
