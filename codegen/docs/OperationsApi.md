...
------------- | ------------- | -------------
[**take_snapshot**](OperationsApi.md#take_snapshot) | **POST** /operations/snapshot | Creates a point-in-time snapshot of a Fastsearch node's state and data in the specified directory.
...
Creates a point-in-time snapshot of a Fastsearch node's state and data in the specified directory.

Creates a point-in-time snapshot of a Fastsearch node's state and data in the specified directory. You can then backup the snapshot directory that gets created and later restore it as a data directory, as needed.
