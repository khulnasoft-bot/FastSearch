...
pub struct CollectionSchema {
    ...
    /// Enables experimental support at a collection level for nested object or object array fields. This field is only available if the Fastsearch server is version `0.24.0.rcn34` or later.
    #[serde(
