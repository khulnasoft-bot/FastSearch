...
pub async fn delete_document(
    ...
    if let Some(ref local_var_apikey) = local_var_configuration.api_key {
        ...
        local_var_req_builder =
            local_var_req_builder.header("X-FASTSEARCH-API-KEY", local_var_value);
    };
...
pub async fn update_documents(
    ...
    update_documents_parameters: Option<
        crate::models::UpdateDocumentsUpdateDocumentsParametersParameter,
    >,
    ...
    if let Some(ref update_documents_parameters_ref) = update_documents_parameters {
        local_var_req_builder = local_var_req_builder.query(&update_documents_parameters_ref);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateDocumentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
